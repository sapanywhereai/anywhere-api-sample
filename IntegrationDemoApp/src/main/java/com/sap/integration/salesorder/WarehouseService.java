...
import com.sap.integration.salesorder.model.AnwWarehouseDto;
...
public class WarehouseService {
    ...
    public static final AnwWarehouseDto findWarehouse(String whsCode) throws Exception {
        ...
        if (StringUtils.isNotBlank(whsCode)) {
            AnwSimpleResponse result = AnwServiceCall.get(getWarehouseLinkFind(whsCode), null);
    ...
    public static final List<AnwWarehouseDto> findAllWarehouses() throws Exception {
        ...
        do {
            AnwSimpleResponse result = AnwServiceCall.get(getWarehouseLinkSelect(cycle * AnwUrlUtil.OPENAPI_QEURY_OPTION_LIMIT), null);
